...
import CheckboxBlankOutlineIcon from 'react-svg-loader!@mdi/svg/svg/checkbox-blank-outline.svg'
import CheckboxMarkedIcon from 'react-svg-loader!@mdi/svg/svg/checkbox-marked.svg'
...
export default function Checkbox({
  ...
  return (
    <SCheckbox disabled={disabled} labelDirection={labelDirection} style={style}>
      ...
      <Icon size="small" onClick={onClick} dataTest={dataTest}>
        <Component />
      </Icon>
